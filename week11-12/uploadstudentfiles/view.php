	...
	<body>
		<div class="container">			
			<div class="page-header">
				<h1>Library of Files Uploaded</h1>
			</div>
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<br/>
					<!-- We will add our database connection in the php tag below. -->
					<?php 
					...
					?>
					<!-- We will search for images to display in the php tag below. -->
                    ...
                    {
					?>
					<!-- We will state if there are images to display in the php tag below. -->
